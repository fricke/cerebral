...
describe('Model', () => {
  ...
  describe('PUSH', () => {
    ...
    it('should be able to push more than one item to array', () => {
      const model = new Model({
        list: [],
      })
      model.push(['list'], 'bar', 'foo')
  ...
  describe('CONCAT', () => {
    ...
    it('should be able to concat more than two arrays', () => {
      const model = new Model({
        foo: ['foo'],
      })
      model.concat(['foo'], ['bar'], ['baz'])
      assert.deepEqual(model.get(), { foo: ['foo', 'bar', 'baz'] })
    })
  })
